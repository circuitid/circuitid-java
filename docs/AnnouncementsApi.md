...
# **createAnnouncement**
> Object createAnnouncement(announcements)
...
import CircuitID.AnnouncementsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Object result = apiInstance.createAnnouncement(announcements);
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Object result = apiInstance.getAnnouncement(id);
      System.out.println(result);
    } catch (ApiException e) {
...
# **patchAnnouncement**
> Object patchAnnouncement(id, announcements)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Object result = apiInstance.patchAnnouncement(id, announcements);
      System.out.println(result);
    } catch (ApiException e) {
...
public class Example {
  public static void main(String[] args) {
    ...
    Object id = null; // Object | The ObjectId (unique 12 bytes ID) of record you would like to GET.
    try {
      Object result = apiInstance.removeAnnouncement(id);
      System.out.println(result);
    } catch (ApiException e) {
