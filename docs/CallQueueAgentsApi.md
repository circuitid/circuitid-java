...
> Object createCallQueueAgent(callqueueagents)
...
import CircuitID.CallQueueAgentsApi;
...
# **patchCallQueueAgent**
> Object patchCallQueueAgent(id, callqueueagents)
...
> Object removeCallQueueAgent(id)
