...
public class Example {
  public static void main(String[] args) {
    ...
    Clients clients = new Clients(); // Clients | The JSON object that will be posted to the REST API endpoint.
    try {
      Object result = apiInstance.createClient(clients);
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Object result = apiInstance.getClient(id);
      System.out.println(result);
    } catch (ApiException e) {
...
public class Example {
  public static void main(String[] args) {
    ...
    ClientsApi apiInstance = new ClientsApi(defaultClient);
    Object id = null; // Object | The ObjectId (unique 12 bytes ID) of record you would like to GET.
    Clients clients = new Clients(); // Clients | The request data.
    try {
      Object result = apiInstance.patchClient(id, clients);
      System.out.println(result);
    } catch (ApiException e) {
...
public class Example {
  public static void main(String[] args) {
    ...
    Object id = null; // Object | The ObjectId (unique 12 bytes ID) of record you would like to GET.
    try {
      Object result = apiInstance.removeClient(id);
      System.out.println(result);
    } catch (ApiException e) {
