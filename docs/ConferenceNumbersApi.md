...
<a id="findConferenceNumbers"></a>
# **findConferenceNumbers**
> FindAppMarketplace200Response findConferenceNumbers($search, $limit, $skip, $sort, $select, $or, $and)
...
import com.circuitid.client.api.ConferenceNumbersApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    ConferenceNumbersApi apiInstance = new ConferenceNumbersApi(defaultClient);
    ...
    try {
      FindAppMarketplace200Response result = apiInstance.findConferenceNumbers($search, $limit, $skip, $sort, $select, $or, $and);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ConferenceNumbersApi#findConferenceNumbers");
