...
# **createDeveloperApp**
> Object createDeveloperApp(developerapps)
...
import com.circuitid.client.api.DeveloperAppsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Object result = apiInstance.createDeveloperApp(developerapps);
...
<a id="findDeveloperApps"></a>
# **findDeveloperApps**
> FindDeveloperApps200Response findDeveloperApps($search, $limit, $skip, $sort, $select, $or, $and)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling DeveloperAppsApi#findDeveloperApps");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="getDeveloperApp"></a>
# **getDeveloperApp**
> Object getDeveloperApp(id)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Object result = apiInstance.getDeveloperApp(id);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DeveloperAppsApi#getDeveloperApp");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
# **patchDeveloperApp**
> Object patchDeveloperApp(id, developerapps)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Object result = apiInstance.patchDeveloperApp(id, developerapps);
      System.out.println(result);
    } catch (ApiException e) {
...
<a id="removeDeveloperApp"></a>
# **removeDeveloperApp**
> Object removeDeveloperApp(id)
...
public class Example {
  public static void main(String[] args) {
    ...
    Object id = null; // Object | The ObjectId (unique 12 bytes ID) of record you would like to GET.
    try {
      Object result = apiInstance.removeDeveloperApp(id);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DeveloperAppsApi#removeDeveloperApp");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
