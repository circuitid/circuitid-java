...
<a id="findFindNumbers"></a>
# **findFindNumbers**
> FindAppMarketplace200Response findFindNumbers($search, $limit, $skip, $sort, $select, $or, $and)
...
import com.circuitid.client.api.FindNumbersApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    FindNumbersApi apiInstance = new FindNumbersApi(defaultClient);
    ...
    try {
      FindAppMarketplace200Response result = apiInstance.findFindNumbers($search, $limit, $skip, $sort, $select, $or, $and);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling FindNumbersApi#findFindNumbers");
