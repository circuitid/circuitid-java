...
<a id="findInvoices"></a>
# **findInvoices**
> FindInvoices200Response findInvoices($search, $limit, $skip, $sort, $select, $or, $and)
...
import com.circuitid.client.api.InvoicesApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      FindInvoices200Response result = apiInstance.findInvoices($search, $limit, $skip, $sort, $select, $or, $and);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling InvoicesApi#findInvoices");
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Object result = apiInstance.getInvoice(id);
      System.out.println(result);
    } catch (ApiException e) {
