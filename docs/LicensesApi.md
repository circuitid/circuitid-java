...
public class Example {
  public static void main(String[] args) {
    ...
    Licenses licenses = new Licenses(); // Licenses | The JSON object that will be posted to the REST API endpoint.
    try {
      Object result = apiInstance.createLicense(licenses);
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Object result = apiInstance.getLicense(id);
      System.out.println(result);
    } catch (ApiException e) {
...
<a id="patchLicense"></a>
# **patchLicense**
> Object patchLicense(id, licenses)
...
public class Example {
  public static void main(String[] args) {
    ...
    LicensesApi apiInstance = new LicensesApi(defaultClient);
    Object id = null; // Object | The ObjectId (unique 12 bytes ID) of record you would like to GET.
    Licenses licenses = new Licenses(); // Licenses | The request data.
    try {
      Object result = apiInstance.patchLicense(id, licenses);
      System.out.println(result);
    } catch (ApiException e) {
...
public class Example {
  public static void main(String[] args) {
    ...
    Object id = null; // Object | The ObjectId (unique 12 bytes ID) of record you would like to GET.
    try {
      Object result = apiInstance.removeLicense(id);
      System.out.println(result);
    } catch (ApiException e) {
