...
# **createLicense**
> GetLicense200Response createLicense(licensesCreateOrPatch)
...
import com.circuitid.client.api.LicensesApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    LicensesCreateOrPatch licensesCreateOrPatch = new LicensesCreateOrPatch(); // LicensesCreateOrPatch | The JSON object that will be posted to the REST API endpoint.
    try {
...
<a id="findLicenses"></a>
# **findLicenses**
> FindLicenses200Response findLicenses($search, $limit, $skip, $sort, $select, $or, $and)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      FindLicenses200Response result = apiInstance.findLicenses($search, $limit, $skip, $sort, $select, $or, $and);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling LicensesApi#findLicenses");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="getLicense"></a>
# **getLicense**
> GetLicense200Response getLicense(id)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      GetLicense200Response result = apiInstance.getLicense(id);
      System.out.println(result);
    } catch (ApiException e) {
...
<a id="patchLicense"></a>
# **patchLicense**
> GetLicense200Response patchLicense(id, licensesCreateOrPatch)
...
public class Example {
  public static void main(String[] args) {
    ...
    LicensesApi apiInstance = new LicensesApi(defaultClient);
    String id = "id_example"; // String | The ObjectId (unique 12 bytes ID) of record you would like to GET.
    LicensesCreateOrPatch licensesCreateOrPatch = new LicensesCreateOrPatch(); // LicensesCreateOrPatch | The request data.
    try {
      GetLicense200Response result = apiInstance.patchLicense(id, licensesCreateOrPatch);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling LicensesApi#patchLicense");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="removeLicense"></a>
# **removeLicense**
> GetLicense200Response removeLicense(id)
...
public class Example {
  public static void main(String[] args) {
    ...
    String id = "id_example"; // String | The ObjectId (unique 12 bytes ID) of record you would like to GET.
    try {
      GetLicense200Response result = apiInstance.removeLicense(id);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling LicensesApi#removeLicense");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
