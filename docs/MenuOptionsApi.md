...
import com.circuitid.client.api.MenuOptionsApi;
...
<a id="findMenuOptions"></a>
# **findMenuOptions**
> FindMenuOptions200Response findMenuOptions($search, $limit, $skip, $sort, $select, $or, $and)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling MenuOptionsApi#findMenuOptions");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="getMenuOption"></a>
# **getMenuOption**
> GetMenuOption200Response getMenuOption(id)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      GetMenuOption200Response result = apiInstance.getMenuOption(id);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling MenuOptionsApi#getMenuOption");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="removeMenuOption"></a>
# **removeMenuOption**
> GetMenuOption200Response removeMenuOption(id)
...
public class Example {
  public static void main(String[] args) {
    ...
    String id = "id_example"; // String | The ObjectId (unique 12 bytes ID) of record you would like to GET.
    try {
      GetMenuOption200Response result = apiInstance.removeMenuOption(id);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling MenuOptionsApi#removeMenuOption");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
