...
<a id="findNumbers"></a>
# **findNumbers**
> FindNumbers200Response findNumbers($search, $limit, $skip, $sort, $select, $or, $and)
...
import com.circuitid.client.api.NumbersApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling NumbersApi#findNumbers");
...
<a id="getNumber"></a>
# **getNumber**
> GetNumber200Response getNumber(id)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling NumbersApi#getNumber");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
