...
> Object createPhoneInboundRuleAction(phoneinboundruleactions)
...
import CircuitID.PhoneInboundRuleActionsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Object result = apiInstance.createPhoneInboundRuleAction(phoneinboundruleactions);
...
> Object getPhoneInboundRuleAction(id)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Object result = apiInstance.getPhoneInboundRuleAction(id);
      System.out.println(result);
    } catch (ApiException e) {
...
> Object patchPhoneInboundRuleAction(id, phoneinboundruleactions)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Object result = apiInstance.patchPhoneInboundRuleAction(id, phoneinboundruleactions);
      System.out.println(result);
    } catch (ApiException e) {
...
> Object removePhoneInboundRuleAction(id)
...
public class Example {
  public static void main(String[] args) {
    ...
    Object id = null; // Object | The ObjectId (unique 12 bytes ID) of record you would like to GET.
    try {
      Object result = apiInstance.removePhoneInboundRuleAction(id);
      System.out.println(result);
    } catch (ApiException e) {
