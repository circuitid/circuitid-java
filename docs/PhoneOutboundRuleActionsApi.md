...
> Object createPhoneOutboundRuleAction(phoneoutboundruleactions)
...
import CircuitID.PhoneOutboundRuleActionsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Object result = apiInstance.createPhoneOutboundRuleAction(phoneoutboundruleactions);
...
> Object getPhoneOutboundRuleAction(id)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Object result = apiInstance.getPhoneOutboundRuleAction(id);
      System.out.println(result);
    } catch (ApiException e) {
...
> Object patchPhoneOutboundRuleAction(id, phoneoutboundruleactions)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Object result = apiInstance.patchPhoneOutboundRuleAction(id, phoneoutboundruleactions);
      System.out.println(result);
    } catch (ApiException e) {
...
<a id="removePhoneOutboundRuleAction"></a>
# **removePhoneOutboundRuleAction**
> Object removePhoneOutboundRuleAction(id)
...
public class Example {
  public static void main(String[] args) {
    ...
    Object id = null; // Object | The ObjectId (unique 12 bytes ID) of record you would like to GET.
    try {
      Object result = apiInstance.removePhoneOutboundRuleAction(id);
      System.out.println(result);
    } catch (ApiException e) {
