...
> Object createPhoneOutboundRule(phoneoutboundrules)
...
import CircuitID.PhoneOutboundRulesApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Object result = apiInstance.createPhoneOutboundRule(phoneoutboundrules);
...
> Object getPhoneOutboundRule(id)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Object result = apiInstance.getPhoneOutboundRule(id);
      System.out.println(result);
    } catch (ApiException e) {
...
> Object patchPhoneOutboundRule(id, phoneoutboundrules)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Object result = apiInstance.patchPhoneOutboundRule(id, phoneoutboundrules);
      System.out.println(result);
    } catch (ApiException e) {
...
> Object removePhoneOutboundRule(id)
...
public class Example {
  public static void main(String[] args) {
    ...
    Object id = null; // Object | The ObjectId (unique 12 bytes ID) of record you would like to GET.
    try {
      Object result = apiInstance.removePhoneOutboundRule(id);
      System.out.println(result);
    } catch (ApiException e) {
