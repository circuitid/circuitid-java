...
<a id="findRateCenters"></a>
# **findRateCenters**
> FindRateCenters200Response findRateCenters($search, $limit, $skip, $sort, $select, $or, $and)
...
import com.circuitid.client.api.RateCentersApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    RateCentersApi apiInstance = new RateCentersApi(defaultClient);
    ...
    try {
      ...
      System.err.println("Exception when calling RateCentersApi#findRateCenters");
...
<a id="getRateCenter"></a>
# **getRateCenter**
> Object getRateCenter(id)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Object result = apiInstance.getRateCenter(id);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling RateCentersApi#getRateCenter");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
