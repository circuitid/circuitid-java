...
# **createTimeSchedule**
> Object createTimeSchedule(timeschedules)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Object result = apiInstance.createTimeSchedule(timeschedules);
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Object result = apiInstance.getTimeSchedule(id);
      System.out.println(result);
    } catch (ApiException e) {
...
# **patchTimeSchedule**
> Object patchTimeSchedule(id, timeschedules)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Object result = apiInstance.patchTimeSchedule(id, timeschedules);
      System.out.println(result);
    } catch (ApiException e) {
...
public class Example {
  public static void main(String[] args) {
    ...
    Object id = null; // Object | The ObjectId (unique 12 bytes ID) of record you would like to GET.
    try {
      Object result = apiInstance.removeTimeSchedule(id);
      System.out.println(result);
    } catch (ApiException e) {
