...
<a id="createUser"></a>
# **createUser**
> GetUser200Response createUser(usersCreateOrPatch)
...
import com.circuitid.client.api.UsersApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    UsersCreateOrPatch usersCreateOrPatch = new UsersCreateOrPatch(); // UsersCreateOrPatch | The JSON object that will be posted to the REST API endpoint.
    try {
...
<a id="findUsers"></a>
# **findUsers**
> FindUsers200Response findUsers($search, $limit, $skip, $sort, $select, $or, $and)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      FindUsers200Response result = apiInstance.findUsers($search, $limit, $skip, $sort, $select, $or, $and);
      System.out.println(result);
    } catch (ApiException e) {
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      GetUser200Response result = apiInstance.getUser(id);
      System.out.println(result);
    } catch (ApiException e) {
...
<a id="patchUser"></a>
# **patchUser**
> GetUser200Response patchUser(id, usersCreateOrPatch)
...
public class Example {
  public static void main(String[] args) {
    ...
    UsersApi apiInstance = new UsersApi(defaultClient);
    String id = "id_example"; // String | The ObjectId (unique 12 bytes ID) of record you would like to GET.
    UsersCreateOrPatch usersCreateOrPatch = new UsersCreateOrPatch(); // UsersCreateOrPatch | The request data.
    try {
...
<a id="removeUser"></a>
# **removeUser**
> GetUser200Response removeUser(id)
...
public class Example {
  public static void main(String[] args) {
    ...
    String id = "id_example"; // String | The ObjectId (unique 12 bytes ID) of record you would like to GET.
    try {
      GetUser200Response result = apiInstance.removeUser(id);
      System.out.println(result);
    } catch (ApiException e) {
