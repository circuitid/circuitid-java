...
public class ClientsApi {
     ...
     */
    public GetClient200Response createClient(Clients clients) throws ApiException {
        ApiResponse<GetClient200Response> localVarResp = createClientWithHttpInfo(clients);
     ...
     */
    public ApiResponse<GetClient200Response> createClientWithHttpInfo(Clients clients) throws ApiException {
     ...
     */
    public okhttp3.Call createClientAsync(Clients clients, final ApiCallback<GetClient200Response> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call patchClientCall(String id, Clients clients, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call patchClientValidateBeforeCall(String id, Clients clients, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
     ...
     */
    public GetClient200Response patchClient(String id, Clients clients) throws ApiException {
        ApiResponse<GetClient200Response> localVarResp = patchClientWithHttpInfo(id, clients);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<GetClient200Response> patchClientWithHttpInfo(String id, Clients clients) throws ApiException {
     ...
     */
    public okhttp3.Call patchClientAsync(String id, Clients clients, final ApiCallback<GetClient200Response> _callback) throws ApiException {
