...
public class DnsRecordsApi {
     ...
     */
    public okhttp3.Call findDNSRecordsCall(String $search, Integer $limit, Integer $skip, Object $sort, List<String> $select, List<Object> $or, List<Object> $and, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/dnsrecords";
    ...
    private okhttp3.Call findDNSRecordsValidateBeforeCall(String $search, Integer $limit, Integer $skip, Object $sort, List<String> $select, List<Object> $or, List<Object> $and, final ApiCallback _callback) throws ApiException {
        return findDNSRecordsCall($search, $limit, $skip, $sort, $select, $or, $and, _callback);
     ...
     */
    public FindAppMarketplace200Response findDNSRecords(String $search, Integer $limit, Integer $skip, Object $sort, List<String> $select, List<Object> $or, List<Object> $and) throws ApiException {
        ApiResponse<FindAppMarketplace200Response> localVarResp = findDNSRecordsWithHttpInfo($search, $limit, $skip, $sort, $select, $or, $and);
     ...
     */
    public ApiResponse<FindAppMarketplace200Response> findDNSRecordsWithHttpInfo(String $search, Integer $limit, Integer $skip, Object $sort, List<String> $select, List<Object> $or, List<Object> $and) throws ApiException {
        okhttp3.Call localVarCall = findDNSRecordsValidateBeforeCall($search, $limit, $skip, $sort, $select, $or, $and, null);
     ...
     */
    public okhttp3.Call findDNSRecordsAsync(String $search, Integer $limit, Integer $skip, Object $sort, List<String> $select, List<Object> $or, List<Object> $and, final ApiCallback<FindAppMarketplace200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = findDNSRecordsValidateBeforeCall($search, $limit, $skip, $sort, $select, $or, $and, _callback);
        Type localVarReturnType = new TypeToken<FindAppMarketplace200Response>(){}.getType();
