...
public class GroupMembersApi {
     ...
     * @param groupmembersCreateOrPatch The JSON object that will be posted to the REST API endpoint. (required)
     ...
     */
    public okhttp3.Call createGroupMemberCall(GroupmembersCreateOrPatch groupmembersCreateOrPatch, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = groupmembersCreateOrPatch;
    ...
    private okhttp3.Call createGroupMemberValidateBeforeCall(GroupmembersCreateOrPatch groupmembersCreateOrPatch, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'groupmembersCreateOrPatch' is set
        if (groupmembersCreateOrPatch == null) {
            throw new ApiException("Missing the required parameter 'groupmembersCreateOrPatch' when calling createGroupMember(Async)");
        }

        return createGroupMemberCall(groupmembersCreateOrPatch, _callback);
     ...
     */
    public GetGroupMember200Response createGroupMember(GroupmembersCreateOrPatch groupmembersCreateOrPatch) throws ApiException {
        ApiResponse<GetGroupMember200Response> localVarResp = createGroupMemberWithHttpInfo(groupmembersCreateOrPatch);
     ...
     */
    public ApiResponse<GetGroupMember200Response> createGroupMemberWithHttpInfo(GroupmembersCreateOrPatch groupmembersCreateOrPatch) throws ApiException {
        okhttp3.Call localVarCall = createGroupMemberValidateBeforeCall(groupmembersCreateOrPatch, null);
     ...
     */
    public okhttp3.Call createGroupMemberAsync(GroupmembersCreateOrPatch groupmembersCreateOrPatch, final ApiCallback<GetGroupMember200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = createGroupMemberValidateBeforeCall(groupmembersCreateOrPatch, _callback);
        Type localVarReturnType = new TypeToken<GetGroupMember200Response>(){}.getType();
     ...
     * @param id The ObjectId (unique 12 bytes ID) of record you would like to GET. (required)
     * @param groupmembersCreateOrPatch The request data. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call patchGroupMemberCall(String id, GroupmembersCreateOrPatch groupmembersCreateOrPatch, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call patchGroupMemberValidateBeforeCall(String id, GroupmembersCreateOrPatch groupmembersCreateOrPatch, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
        ...
        // verify the required parameter 'groupmembersCreateOrPatch' is set
        if (groupmembersCreateOrPatch == null) {
            throw new ApiException("Missing the required parameter 'groupmembersCreateOrPatch' when calling patchGroupMember(Async)");
        }

        return patchGroupMemberCall(id, groupmembersCreateOrPatch, _callback);
     ...
     */
    public GetGroupMember200Response patchGroupMember(String id, GroupmembersCreateOrPatch groupmembersCreateOrPatch) throws ApiException {
        ApiResponse<GetGroupMember200Response> localVarResp = patchGroupMemberWithHttpInfo(id, groupmembersCreateOrPatch);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<GetGroupMember200Response> patchGroupMemberWithHttpInfo(String id, GroupmembersCreateOrPatch groupmembersCreateOrPatch) throws ApiException {
        okhttp3.Call localVarCall = patchGroupMemberValidateBeforeCall(id, groupmembersCreateOrPatch, null);
        Type localVarReturnType = new TypeToken<GetGroupMember200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call patchGroupMemberAsync(String id, GroupmembersCreateOrPatch groupmembersCreateOrPatch, final ApiCallback<GetGroupMember200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = patchGroupMemberValidateBeforeCall(id, groupmembersCreateOrPatch, _callback);
        Type localVarReturnType = new TypeToken<GetGroupMember200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
