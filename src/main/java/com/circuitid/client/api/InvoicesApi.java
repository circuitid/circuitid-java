...
import com.circuitid.client.model.FindInvoices200Response;
...
public class InvoicesApi {
     ...
     */
    public okhttp3.Call findInvoicesCall(Object $search, Object $limit, Object $skip, Object $sort, Object $select, Object $or, Object $and, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call findInvoicesValidateBeforeCall(Object $search, Object $limit, Object $skip, Object $sort, Object $select, Object $or, Object $and, final ApiCallback _callback) throws ApiException {
        return findInvoicesCall($search, $limit, $skip, $sort, $select, $or, $and, _callback);
     ...
     */
    public FindInvoices200Response findInvoices(Object $search, Object $limit, Object $skip, Object $sort, Object $select, Object $or, Object $and) throws ApiException {
        ApiResponse<FindInvoices200Response> localVarResp = findInvoicesWithHttpInfo($search, $limit, $skip, $sort, $select, $or, $and);
     ...
     * @param $or Find all records that match any of the given criteria. (optional)
     * @param $and Find all records that match all of the given criteria. (optional)
     * @return ApiResponse&lt;FindInvoices200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<FindInvoices200Response> findInvoicesWithHttpInfo(Object $search, Object $limit, Object $skip, Object $sort, Object $select, Object $or, Object $and) throws ApiException {
        okhttp3.Call localVarCall = findInvoicesValidateBeforeCall($search, $limit, $skip, $sort, $select, $or, $and, null);
        Type localVarReturnType = new TypeToken<FindInvoices200Response>(){}.getType();
     ...
     */
    public okhttp3.Call findInvoicesAsync(Object $search, Object $limit, Object $skip, Object $sort, Object $select, Object $or, Object $and, final ApiCallback<FindInvoices200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = findInvoicesValidateBeforeCall($search, $limit, $skip, $sort, $select, $or, $and, _callback);
        Type localVarReturnType = new TypeToken<FindInvoices200Response>(){}.getType();
     ...
     */
    public okhttp3.Call getInvoiceCall(Object id, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getInvoiceValidateBeforeCall(Object id, final ApiCallback _callback) throws ApiException {
     ...
     */
    public Object getInvoice(Object id) throws ApiException {
        ApiResponse<Object> localVarResp = getInvoiceWithHttpInfo(id);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Object> getInvoiceWithHttpInfo(Object id) throws ApiException {
     ...
     */
    public okhttp3.Call getInvoiceAsync(Object id, final ApiCallback<Object> _callback) throws ApiException {
