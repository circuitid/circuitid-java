...
public class MessageBrandsApi {
     ...
     */
    public GetMessageBrand200Response createMessageBrand(Messagebrands messagebrands) throws ApiException {
        ApiResponse<GetMessageBrand200Response> localVarResp = createMessageBrandWithHttpInfo(messagebrands);
     ...
     */
    public ApiResponse<GetMessageBrand200Response> createMessageBrandWithHttpInfo(Messagebrands messagebrands) throws ApiException {
     ...
     */
    public okhttp3.Call createMessageBrandAsync(Messagebrands messagebrands, final ApiCallback<GetMessageBrand200Response> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call patchMessageBrandCall(String id, Messagebrands messagebrands, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call patchMessageBrandValidateBeforeCall(String id, Messagebrands messagebrands, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
     ...
     */
    public GetMessageBrand200Response patchMessageBrand(String id, Messagebrands messagebrands) throws ApiException {
        ApiResponse<GetMessageBrand200Response> localVarResp = patchMessageBrandWithHttpInfo(id, messagebrands);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<GetMessageBrand200Response> patchMessageBrandWithHttpInfo(String id, Messagebrands messagebrands) throws ApiException {
     ...
     */
    public okhttp3.Call patchMessageBrandAsync(String id, Messagebrands messagebrands, final ApiCallback<GetMessageBrand200Response> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call removeMessageBrandCall(String id, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call removeMessageBrandValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
     ...
     */
    public GetMessageBrand200Response removeMessageBrand(String id) throws ApiException {
        ApiResponse<GetMessageBrand200Response> localVarResp = removeMessageBrandWithHttpInfo(id);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<GetMessageBrand200Response> removeMessageBrandWithHttpInfo(String id) throws ApiException {
     ...
     */
    public okhttp3.Call removeMessageBrandAsync(String id, final ApiCallback<GetMessageBrand200Response> _callback) throws ApiException {
