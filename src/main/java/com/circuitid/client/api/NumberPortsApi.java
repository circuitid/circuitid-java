...
public class NumberPortsApi {
     ...
     */
    public GetNumberPort200Response createNumberPort(Numberports numberports) throws ApiException {
        ApiResponse<GetNumberPort200Response> localVarResp = createNumberPortWithHttpInfo(numberports);
     ...
     */
    public ApiResponse<GetNumberPort200Response> createNumberPortWithHttpInfo(Numberports numberports) throws ApiException {
     ...
     */
    public okhttp3.Call createNumberPortAsync(Numberports numberports, final ApiCallback<GetNumberPort200Response> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call patchNumberPortCall(String id, Numberports numberports, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call patchNumberPortValidateBeforeCall(String id, Numberports numberports, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
     ...
     */
    public GetNumberPort200Response patchNumberPort(String id, Numberports numberports) throws ApiException {
        ApiResponse<GetNumberPort200Response> localVarResp = patchNumberPortWithHttpInfo(id, numberports);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<GetNumberPort200Response> patchNumberPortWithHttpInfo(String id, Numberports numberports) throws ApiException {
     ...
     */
    public okhttp3.Call patchNumberPortAsync(String id, Numberports numberports, final ApiCallback<GetNumberPort200Response> _callback) throws ApiException {
