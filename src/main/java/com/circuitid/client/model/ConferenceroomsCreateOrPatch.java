...
public class ConferenceroomsCreateOrPatch {
  ...
  public ConferenceroomsCreateOrPatch() {
  }

  public ConferenceroomsCreateOrPatch name(String name) {
  ...
  **/
  ...
  public ConferenceroomsCreateOrPatch passcode(String passcode) {
  ...
  **/
  ...
  public ConferenceroomsCreateOrPatch dialInPin(Integer dialInPin) {
  ...
  **/
  ...
  public ConferenceroomsCreateOrPatch isUserRoom(Boolean isUserRoom) {
  ...
  **/
  ...
  public ConferenceroomsCreateOrPatch isChatRoom(Boolean isChatRoom) {
  ...
  **/
  ...
  public ConferenceroomsCreateOrPatch lobby(LobbyEnum lobby) {
  ...
  **/
  ...
  public ConferenceroomsCreateOrPatch requirePasscode(RequirePasscodeEnum requirePasscode) {
  ...
  **/
  ...
  public ConferenceroomsCreateOrPatch share(ShareEnum share) {
  ...
  **/
  ...
  public ConferenceroomsCreateOrPatch chatroom(String chatroom) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ConferenceroomsCreateOrPatch conferenceroomsCreateOrPatch = (ConferenceroomsCreateOrPatch) o;
    return Objects.equals(this.name, conferenceroomsCreateOrPatch.name) &&
        Objects.equals(this.passcode, conferenceroomsCreateOrPatch.passcode) &&
        Objects.equals(this.dialInPin, conferenceroomsCreateOrPatch.dialInPin) &&
        Objects.equals(this.isUserRoom, conferenceroomsCreateOrPatch.isUserRoom) &&
        Objects.equals(this.isChatRoom, conferenceroomsCreateOrPatch.isChatRoom) &&
        Objects.equals(this.lobby, conferenceroomsCreateOrPatch.lobby) &&
        Objects.equals(this.requirePasscode, conferenceroomsCreateOrPatch.requirePasscode) &&
        Objects.equals(this.share, conferenceroomsCreateOrPatch.share) &&
        Objects.equals(this.chatroom, conferenceroomsCreateOrPatch.chatroom);
  }
  ...
  public String toString() {
    ...
    sb.append("class ConferenceroomsCreateOrPatch {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ConferenceroomsCreateOrPatch
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ConferenceroomsCreateOrPatch.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConferenceroomsCreateOrPatch is not found in the empty JSON string", ConferenceroomsCreateOrPatch.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ConferenceroomsCreateOrPatch.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ConferenceroomsCreateOrPatch` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ConferenceroomsCreateOrPatch.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConferenceroomsCreateOrPatch.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConferenceroomsCreateOrPatch' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConferenceroomsCreateOrPatch> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConferenceroomsCreateOrPatch.class));

       return (TypeAdapter<T>) new TypeAdapter<ConferenceroomsCreateOrPatch>() {
           @Override
           public void write(JsonWriter out, ConferenceroomsCreateOrPatch value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ConferenceroomsCreateOrPatch read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ConferenceroomsCreateOrPatch given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ConferenceroomsCreateOrPatch
  * @throws IOException if the JSON string is invalid with respect to ConferenceroomsCreateOrPatch
  */
  public static ConferenceroomsCreateOrPatch fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConferenceroomsCreateOrPatch.class);
  }

 /**
  * Convert an instance of ConferenceroomsCreateOrPatch to an JSON string
  *
  * @return JSON string
  */
