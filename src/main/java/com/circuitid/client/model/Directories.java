...
public class Directories {
  ...
  public Directories name(String name) {
  ...
  **/
  ...
  public Directories groups(List<String> groups) {
    
    this.groups = groups;
    return this;
  }

  public Directories addGroupsItem(String groupsItem) {
    if (this.groups == null) {
  ...
  **/
  ...
  public Directories announcement(String announcement) {
