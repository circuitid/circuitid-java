...
public class FindConferenceRooms200Response {
  ...
  private List<Conferencerooms> data = new ArrayList<>();
  ...
  **/
  ...
  public FindConferenceRooms200Response data(List<Conferencerooms> data) {
    
    this.data = data;
    return this;
  }

  public FindConferenceRooms200Response addDataItem(Conferencerooms dataItem) {
    if (this.data == null) {
  ...
  **/
  @javax.annotation.Nonnull
  public List<Conferencerooms> getData() {
    return data;
  }


  public void setData(List<Conferencerooms> data) {
    this.data = data;
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      for (int i = 0; i < jsonArraydata.size(); i++) {
        Conferencerooms.validateJsonObject(jsonArraydata.get(i).getAsJsonObject());
      };
  }
