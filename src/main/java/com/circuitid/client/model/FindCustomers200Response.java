...
public class FindCustomers200Response {
  ...
  **/
  ...
  public FindCustomers200Response data(List<Customers> data) {
    
    this.data = data;
    return this;
  }

  public FindCustomers200Response addDataItem(Customers dataItem) {
    if (this.data == null) {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      for (int i = 0; i < jsonArraydata.size(); i++) {
        Customers.validateJsonObject(jsonArraydata.get(i).getAsJsonObject());
      };
  }
