...
public class FindMessageBrands200Response {
  ...
  private List<Messagebrands> data = new ArrayList<>();
  ...
  **/
  ...
  public FindMessageBrands200Response data(List<Messagebrands> data) {
    
    this.data = data;
    return this;
  }

  public FindMessageBrands200Response addDataItem(Messagebrands dataItem) {
    if (this.data == null) {
  ...
  **/
  @javax.annotation.Nonnull
  public List<Messagebrands> getData() {
    return data;
  }


  public void setData(List<Messagebrands> data) {
    this.data = data;
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      for (int i = 0; i < jsonArraydata.size(); i++) {
        Messagebrands.validateJsonObject(jsonArraydata.get(i).getAsJsonObject());
      };
  }
