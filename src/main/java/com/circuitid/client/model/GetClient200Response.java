...
public class GetClient200Response {
  ...
  public GetClient200Response name(String name) {
  ...
  **/
  ...
  public GetClient200Response user(String user) {
  ...
  **/
  ...
  public GetClient200Response mac(String mac) {
  ...
  **/
  ...
  public GetClient200Response httpUserAgent(String httpUserAgent) {
  ...
  **/
  ...
  public GetClient200Response manufacture(ManufactureEnum manufacture) {
  ...
  **/
  ...
  public GetClient200Response status(StatusEnum status) {
  ...
  **/
  ...
  public GetClient200Response id(String id) {
  ...
  **/
  ...
  public GetClient200Response createdByUserId(String createdByUserId) {
  ...
  **/
  ...
  public GetClient200Response updatedByUserId(String updatedByUserId) {
  ...
  **/
  ...
  public GetClient200Response createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public GetClient200Response updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    GetClient200Response getClient200Response = (GetClient200Response) o;
    return Objects.equals(this.name, getClient200Response.name) &&
        Objects.equals(this.user, getClient200Response.user) &&
        Objects.equals(this.mac, getClient200Response.mac) &&
        Objects.equals(this.httpUserAgent, getClient200Response.httpUserAgent) &&
        Objects.equals(this.manufacture, getClient200Response.manufacture) &&
        Objects.equals(this.status, getClient200Response.status) &&
        Objects.equals(this.id, getClient200Response.id) &&
        Objects.equals(this.createdByUserId, getClient200Response.createdByUserId) &&
        Objects.equals(this.updatedByUserId, getClient200Response.updatedByUserId) &&
        Objects.equals(this.createdAt, getClient200Response.createdAt) &&
        Objects.equals(this.updatedAt, getClient200Response.updatedAt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, user, mac, httpUserAgent, manufacture, status, id, createdByUserId, updatedByUserId, createdAt, updatedAt);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GetClient200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetClient200Response is not found in the empty JSON string", GetClient200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!GetClient200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetClient200Response` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetClient200Response.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<GetClient200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetClient200Response.class));
