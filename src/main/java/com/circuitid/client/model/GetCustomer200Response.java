...
public class GetCustomer200Response {
  ...
  private Integer callForwardingCallLimit = 10;
  ...
  private OffsetDateTime lowBalanceAlertAt;
  ...
  private Integer lowBalanceAlertCount = 0;
  ...
  private String lastAutomaticRefillInvoice;
  ...
  public enum CallDebugEnum {
    ...
    public static CallDebugEnum fromValue(Integer value) {
  ...
  private CallDebugEnum callDebug = CallDebugEnum.NUMBER_0;
  ...
  **/
  ...
  public GetCustomer200Response status(StatusEnum status) {
  ...
  **/
  ...
  public GetCustomer200Response callForwardingCallLimit(Integer callForwardingCallLimit) {
  ...
  **/
  @javax.annotation.Nullable
  public Integer getCallForwardingCallLimit() {
    return callForwardingCallLimit;
  }


  public void setCallForwardingCallLimit(Integer callForwardingCallLimit) {
    this.callForwardingCallLimit = callForwardingCallLimit;
  }
  ...
  **/
  ...
  public GetCustomer200Response lowBalanceAlertAt(OffsetDateTime lowBalanceAlertAt) {
  ...
  **/
  @javax.annotation.Nullable
  public OffsetDateTime getLowBalanceAlertAt() {
    return lowBalanceAlertAt;
  }


  public void setLowBalanceAlertAt(OffsetDateTime lowBalanceAlertAt) {
    this.lowBalanceAlertAt = lowBalanceAlertAt;
  }


  public GetCustomer200Response lowBalanceAlertCount(Integer lowBalanceAlertCount) {
  ...
  **/
  @javax.annotation.Nullable
  public Integer getLowBalanceAlertCount() {
    return lowBalanceAlertCount;
  }


  public void setLowBalanceAlertCount(Integer lowBalanceAlertCount) {
    this.lowBalanceAlertCount = lowBalanceAlertCount;
  }


  public GetCustomer200Response lastAutomaticRefillInvoice(String lastAutomaticRefillInvoice) {
  ...
  **/
  @javax.annotation.Nullable
  public String getLastAutomaticRefillInvoice() {
    return lastAutomaticRefillInvoice;
  }


  public void setLastAutomaticRefillInvoice(String lastAutomaticRefillInvoice) {
    this.lastAutomaticRefillInvoice = lastAutomaticRefillInvoice;
  }
  ...
  **/
  ...
  public GetCustomer200Response callDebug(CallDebugEnum callDebug) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, getCustomer200Response.name) &&
        Objects.equals(this.status, getCustomer200Response.status) &&
        ...
        Objects.equals(this.callForwardingCallLimit, getCustomer200Response.callForwardingCallLimit) &&
        ...
        Objects.equals(this.lowBalanceAlertAt, getCustomer200Response.lowBalanceAlertAt) &&
        Objects.equals(this.lowBalanceAlertCount, getCustomer200Response.lowBalanceAlertCount) &&
        Objects.equals(this.lastAutomaticRefillInvoice, getCustomer200Response.lastAutomaticRefillInvoice) &&
        ...
        Objects.equals(this.callDebug, getCustomer200Response.callDebug) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, status, websiteUrl, logo, credit, adminUserId, billingUserId, callRecordingUserId, callForwardingCallLimit, supportUserId, automaticRefillAmount, lowBalanceAlertAmount, lowBalanceAlertAt, lowBalanceAlertCount, lastAutomaticRefillInvoice, internationalCalling, createdByIP, callDebug, mediaBypass, accountLock, callRecording, cdrRetention, cnamLookUps, holdMusic, transcribeCalls, maxOutboundCallRate, defaultBillMethod, createdByUserId, updatedByUserId, createdAt, updatedAt);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if ((jsonObj.get("lastAutomaticRefillInvoice") != null && !jsonObj.get("lastAutomaticRefillInvoice").isJsonNull()) && !jsonObj.get("lastAutomaticRefillInvoice").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `lastAutomaticRefillInvoice` to be a primitive type in the JSON string but got `%s`", jsonObj.get("lastAutomaticRefillInvoice").toString()));
      }
