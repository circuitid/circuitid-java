...
public class GetHoliday200Response {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, _object, objectRef, dateTimeRanges, status, destinationType, destination, ref, callForwardingDestination, createdByUserId, updatedByUserId, createdAt, updatedAt);
  }
