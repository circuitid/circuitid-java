...
public class GetMessageCampaign200Response {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, campaignId, brandId, order, subscriberOptin, subscriberOptout, subscriberHelp, numberPool, directLending, embeddedLink, embeddedPhone, affiliateMarketing, ageGated, mnos, referenceId, useCase, subUseCases, sample1, sample2, sample3, sample4, sample5, createdByUserId, updatedByUserId, createdAt, updatedAt);
  }
