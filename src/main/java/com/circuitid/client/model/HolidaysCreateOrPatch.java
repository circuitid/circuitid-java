...
public class HolidaysCreateOrPatch {
  ...
  public HolidaysCreateOrPatch() {
  }

  public HolidaysCreateOrPatch name(String name) {
  ...
  **/
  ...
  public HolidaysCreateOrPatch _object(String _object) {
  ...
  **/
  ...
  public HolidaysCreateOrPatch objectRef(String objectRef) {
  ...
  **/
  ...
  public HolidaysCreateOrPatch dateTimeRanges(List<List<OffsetDateTime>> dateTimeRanges) {
    
    this.dateTimeRanges = dateTimeRanges;
    return this;
  }

  public HolidaysCreateOrPatch addDateTimeRangesItem(List<OffsetDateTime> dateTimeRangesItem) {
  ...
  **/
  ...
  public HolidaysCreateOrPatch status(StatusEnum status) {
  ...
  **/
  ...
  public HolidaysCreateOrPatch destinationType(DestinationTypeEnum destinationType) {
  ...
  **/
  ...
  public HolidaysCreateOrPatch destination(String destination) {
  ...
  **/
  ...
  public HolidaysCreateOrPatch ref(String ref) {
  ...
  **/
  ...
  public HolidaysCreateOrPatch callForwardingDestination(String callForwardingDestination) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    HolidaysCreateOrPatch holidaysCreateOrPatch = (HolidaysCreateOrPatch) o;
    return Objects.equals(this.name, holidaysCreateOrPatch.name) &&
        Objects.equals(this._object, holidaysCreateOrPatch._object) &&
        Objects.equals(this.objectRef, holidaysCreateOrPatch.objectRef) &&
        Objects.equals(this.dateTimeRanges, holidaysCreateOrPatch.dateTimeRanges) &&
        Objects.equals(this.status, holidaysCreateOrPatch.status) &&
        Objects.equals(this.destinationType, holidaysCreateOrPatch.destinationType) &&
        Objects.equals(this.destination, holidaysCreateOrPatch.destination) &&
        Objects.equals(this.ref, holidaysCreateOrPatch.ref) &&
        Objects.equals(this.callForwardingDestination, holidaysCreateOrPatch.callForwardingDestination);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to HolidaysCreateOrPatch
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!HolidaysCreateOrPatch.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in HolidaysCreateOrPatch is not found in the empty JSON string", HolidaysCreateOrPatch.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!HolidaysCreateOrPatch.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `HolidaysCreateOrPatch` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : HolidaysCreateOrPatch.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!HolidaysCreateOrPatch.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'HolidaysCreateOrPatch' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<HolidaysCreateOrPatch> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(HolidaysCreateOrPatch.class));

       return (TypeAdapter<T>) new TypeAdapter<HolidaysCreateOrPatch>() {
           @Override
           public void write(JsonWriter out, HolidaysCreateOrPatch value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public HolidaysCreateOrPatch read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of HolidaysCreateOrPatch given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of HolidaysCreateOrPatch
  * @throws IOException if the JSON string is invalid with respect to HolidaysCreateOrPatch
  */
  public static HolidaysCreateOrPatch fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, HolidaysCreateOrPatch.class);
  }

 /**
  * Convert an instance of HolidaysCreateOrPatch to an JSON string
  *
  * @return JSON string
  */
