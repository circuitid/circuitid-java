...
public class MessagebrandsCreateOrPatch {
  ...
  public MessagebrandsCreateOrPatch() {
  }

  public MessagebrandsCreateOrPatch name(String name) {
  ...
  **/
  ...
  public MessagebrandsCreateOrPatch brandId(String brandId) {
  ...
  **/
  ...
  public MessagebrandsCreateOrPatch ein(String ein) {
  ...
  **/
  ...
  public MessagebrandsCreateOrPatch user(String user) {
  ...
  **/
  ...
  public MessagebrandsCreateOrPatch order(String order) {
  ...
  **/
  ...
  public MessagebrandsCreateOrPatch brandRelationship(String brandRelationship) {
  ...
  **/
  ...
  public MessagebrandsCreateOrPatch vertical(String vertical) {
  ...
  **/
  ...
  public MessagebrandsCreateOrPatch entityType(String entityType) {
  ...
  **/
  ...
  public MessagebrandsCreateOrPatch cspId(String cspId) {
  ...
  **/
  ...
  public MessagebrandsCreateOrPatch einIssuingCountry(String einIssuingCountry) {
  ...
  **/
  ...
  public MessagebrandsCreateOrPatch universalEin(String universalEin) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    MessagebrandsCreateOrPatch messagebrandsCreateOrPatch = (MessagebrandsCreateOrPatch) o;
    return Objects.equals(this.name, messagebrandsCreateOrPatch.name) &&
        Objects.equals(this.brandId, messagebrandsCreateOrPatch.brandId) &&
        Objects.equals(this.ein, messagebrandsCreateOrPatch.ein) &&
        Objects.equals(this.user, messagebrandsCreateOrPatch.user) &&
        Objects.equals(this.order, messagebrandsCreateOrPatch.order) &&
        Objects.equals(this.brandRelationship, messagebrandsCreateOrPatch.brandRelationship) &&
        Objects.equals(this.vertical, messagebrandsCreateOrPatch.vertical) &&
        Objects.equals(this.entityType, messagebrandsCreateOrPatch.entityType) &&
        Objects.equals(this.cspId, messagebrandsCreateOrPatch.cspId) &&
        Objects.equals(this.einIssuingCountry, messagebrandsCreateOrPatch.einIssuingCountry) &&
        Objects.equals(this.universalEin, messagebrandsCreateOrPatch.universalEin);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, brandId, ein, user, order, brandRelationship, vertical, entityType, cspId, einIssuingCountry, universalEin);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MessagebrandsCreateOrPatch {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to MessagebrandsCreateOrPatch
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MessagebrandsCreateOrPatch.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MessagebrandsCreateOrPatch is not found in the empty JSON string", MessagebrandsCreateOrPatch.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!MessagebrandsCreateOrPatch.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MessagebrandsCreateOrPatch` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MessagebrandsCreateOrPatch.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MessagebrandsCreateOrPatch.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MessagebrandsCreateOrPatch' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MessagebrandsCreateOrPatch> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MessagebrandsCreateOrPatch.class));

       return (TypeAdapter<T>) new TypeAdapter<MessagebrandsCreateOrPatch>() {
           @Override
           public void write(JsonWriter out, MessagebrandsCreateOrPatch value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MessagebrandsCreateOrPatch read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of MessagebrandsCreateOrPatch given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MessagebrandsCreateOrPatch
  * @throws IOException if the JSON string is invalid with respect to MessagebrandsCreateOrPatch
  */
  public static MessagebrandsCreateOrPatch fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MessagebrandsCreateOrPatch.class);
  }

 /**
  * Convert an instance of MessagebrandsCreateOrPatch to an JSON string
  *
  * @return JSON string
  */
