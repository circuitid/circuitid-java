...
public class Numbers {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(inUse, name, countryCode, amount, perMinuteRate, fax, voice, status, sms, mms, directoryListing, callerName, e911, messageCampaign, messageClass, messageType, e911Supported, callerNameSupported, directoryListingSupported, messagingSupported, destinationType, destination, ref, callForwardingDestination);
  }
