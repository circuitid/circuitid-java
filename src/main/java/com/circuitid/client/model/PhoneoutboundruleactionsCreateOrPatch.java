...
public class PhoneoutboundruleactionsCreateOrPatch {
  ...
  public PhoneoutboundruleactionsCreateOrPatch() {
  }

  public PhoneoutboundruleactionsCreateOrPatch name(String name) {
  ...
  **/
  ...
  public PhoneoutboundruleactionsCreateOrPatch group(String group) {
  ...
  **/
  ...
  public PhoneoutboundruleactionsCreateOrPatch phoneoutboundrule(String phoneoutboundrule) {
  ...
  **/
  ...
  public PhoneoutboundruleactionsCreateOrPatch status(StatusEnum status) {
  ...
  **/
  ...
  public PhoneoutboundruleactionsCreateOrPatch priority(Integer priority) {
  ...
  **/
  ...
  public PhoneoutboundruleactionsCreateOrPatch startingChars(String startingChars) {
  ...
  **/
  ...
  public PhoneoutboundruleactionsCreateOrPatch contains(String contains) {
  ...
  **/
  ...
  public PhoneoutboundruleactionsCreateOrPatch lengthType(LengthTypeEnum lengthType) {
  ...
  **/
  ...
  public PhoneoutboundruleactionsCreateOrPatch length(Integer length) {
  ...
  **/
  ...
  public PhoneoutboundruleactionsCreateOrPatch appendChars(String appendChars) {
  ...
  **/
  ...
  public PhoneoutboundruleactionsCreateOrPatch prependChars(String prependChars) {
  ...
  **/
  ...
  public PhoneoutboundruleactionsCreateOrPatch rangeStart(Integer rangeStart) {
  ...
  **/
  ...
  public PhoneoutboundruleactionsCreateOrPatch rangeEnd(Integer rangeEnd) {
  ...
  **/
  ...
  public PhoneoutboundruleactionsCreateOrPatch removeStartingChars(Integer removeStartingChars) {
  ...
  **/
  ...
  public PhoneoutboundruleactionsCreateOrPatch removeEndingChars(Integer removeEndingChars) {
  ...
  **/
  ...
  public PhoneoutboundruleactionsCreateOrPatch route(RouteEnum route) {
  ...
  **/
  ...
  public PhoneoutboundruleactionsCreateOrPatch routingType(RoutingTypeEnum routingType) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PhoneoutboundruleactionsCreateOrPatch phoneoutboundruleactionsCreateOrPatch = (PhoneoutboundruleactionsCreateOrPatch) o;
    return Objects.equals(this.name, phoneoutboundruleactionsCreateOrPatch.name) &&
        Objects.equals(this.group, phoneoutboundruleactionsCreateOrPatch.group) &&
        Objects.equals(this.phoneoutboundrule, phoneoutboundruleactionsCreateOrPatch.phoneoutboundrule) &&
        Objects.equals(this.status, phoneoutboundruleactionsCreateOrPatch.status) &&
        Objects.equals(this.priority, phoneoutboundruleactionsCreateOrPatch.priority) &&
        Objects.equals(this.startingChars, phoneoutboundruleactionsCreateOrPatch.startingChars) &&
        Objects.equals(this.contains, phoneoutboundruleactionsCreateOrPatch.contains) &&
        Objects.equals(this.lengthType, phoneoutboundruleactionsCreateOrPatch.lengthType) &&
        Objects.equals(this.length, phoneoutboundruleactionsCreateOrPatch.length) &&
        Objects.equals(this.appendChars, phoneoutboundruleactionsCreateOrPatch.appendChars) &&
        Objects.equals(this.prependChars, phoneoutboundruleactionsCreateOrPatch.prependChars) &&
        Objects.equals(this.rangeStart, phoneoutboundruleactionsCreateOrPatch.rangeStart) &&
        Objects.equals(this.rangeEnd, phoneoutboundruleactionsCreateOrPatch.rangeEnd) &&
        Objects.equals(this.removeStartingChars, phoneoutboundruleactionsCreateOrPatch.removeStartingChars) &&
        Objects.equals(this.removeEndingChars, phoneoutboundruleactionsCreateOrPatch.removeEndingChars) &&
        Objects.equals(this.route, phoneoutboundruleactionsCreateOrPatch.route) &&
        Objects.equals(this.routingType, phoneoutboundruleactionsCreateOrPatch.routingType);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PhoneoutboundruleactionsCreateOrPatch
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PhoneoutboundruleactionsCreateOrPatch.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PhoneoutboundruleactionsCreateOrPatch is not found in the empty JSON string", PhoneoutboundruleactionsCreateOrPatch.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PhoneoutboundruleactionsCreateOrPatch.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PhoneoutboundruleactionsCreateOrPatch` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PhoneoutboundruleactionsCreateOrPatch.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PhoneoutboundruleactionsCreateOrPatch.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PhoneoutboundruleactionsCreateOrPatch' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PhoneoutboundruleactionsCreateOrPatch> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PhoneoutboundruleactionsCreateOrPatch.class));

       return (TypeAdapter<T>) new TypeAdapter<PhoneoutboundruleactionsCreateOrPatch>() {
           @Override
           public void write(JsonWriter out, PhoneoutboundruleactionsCreateOrPatch value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PhoneoutboundruleactionsCreateOrPatch read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of PhoneoutboundruleactionsCreateOrPatch given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PhoneoutboundruleactionsCreateOrPatch
  * @throws IOException if the JSON string is invalid with respect to PhoneoutboundruleactionsCreateOrPatch
  */
  public static PhoneoutboundruleactionsCreateOrPatch fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PhoneoutboundruleactionsCreateOrPatch.class);
  }

 /**
  * Convert an instance of PhoneoutboundruleactionsCreateOrPatch to an JSON string
  *
  * @return JSON string
  */
