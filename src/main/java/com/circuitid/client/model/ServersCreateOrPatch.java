...
public class ServersCreateOrPatch {
  ...
  public ServersCreateOrPatch() {
  }

  public ServersCreateOrPatch name(String name) {
  ...
  **/
  ...
  public ServersCreateOrPatch host(String host) {
  ...
  **/
  ...
  public ServersCreateOrPatch port(Integer port) {
  ...
  **/
  ...
  public ServersCreateOrPatch callerId(String callerId) {
  ...
  **/
  ...
  public ServersCreateOrPatch type(TypeEnum type) {
  ...
  **/
  ...
  public ServersCreateOrPatch inboundSipTrunkingOrder(String inboundSipTrunkingOrder) {
  ...
  **/
  ...
  public ServersCreateOrPatch outboundSipTrunkingOrder(String outboundSipTrunkingOrder) {
  ...
  **/
  ...
  public ServersCreateOrPatch noInstantRingBack(NoInstantRingBackEnum noInstantRingBack) {
  ...
  **/
  ...
  public ServersCreateOrPatch bypassMedia(BypassMediaEnum bypassMedia) {
  ...
  **/
  ...
  public ServersCreateOrPatch disableRTPAutoAdjust(DisableRTPAutoAdjustEnum disableRTPAutoAdjust) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ServersCreateOrPatch serversCreateOrPatch = (ServersCreateOrPatch) o;
    return Objects.equals(this.name, serversCreateOrPatch.name) &&
        Objects.equals(this.host, serversCreateOrPatch.host) &&
        Objects.equals(this.port, serversCreateOrPatch.port) &&
        Objects.equals(this.callerId, serversCreateOrPatch.callerId) &&
        Objects.equals(this.type, serversCreateOrPatch.type) &&
        Objects.equals(this.inboundSipTrunkingOrder, serversCreateOrPatch.inboundSipTrunkingOrder) &&
        Objects.equals(this.outboundSipTrunkingOrder, serversCreateOrPatch.outboundSipTrunkingOrder) &&
        Objects.equals(this.noInstantRingBack, serversCreateOrPatch.noInstantRingBack) &&
        Objects.equals(this.bypassMedia, serversCreateOrPatch.bypassMedia) &&
        Objects.equals(this.disableRTPAutoAdjust, serversCreateOrPatch.disableRTPAutoAdjust);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, host, port, callerId, type, inboundSipTrunkingOrder, outboundSipTrunkingOrder, noInstantRingBack, bypassMedia, disableRTPAutoAdjust);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ServersCreateOrPatch
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ServersCreateOrPatch.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServersCreateOrPatch is not found in the empty JSON string", ServersCreateOrPatch.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ServersCreateOrPatch.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ServersCreateOrPatch` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ServersCreateOrPatch.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServersCreateOrPatch.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServersCreateOrPatch' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServersCreateOrPatch> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServersCreateOrPatch.class));

       return (TypeAdapter<T>) new TypeAdapter<ServersCreateOrPatch>() {
           @Override
           public void write(JsonWriter out, ServersCreateOrPatch value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ServersCreateOrPatch read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ServersCreateOrPatch given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ServersCreateOrPatch
  * @throws IOException if the JSON string is invalid with respect to ServersCreateOrPatch
  */
  public static ServersCreateOrPatch fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServersCreateOrPatch.class);
  }

 /**
  * Convert an instance of ServersCreateOrPatch to an JSON string
  *
  * @return JSON string
  */
