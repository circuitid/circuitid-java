...
public class TimeschedulesCreateOrPatch {
  ...
  public TimeschedulesCreateOrPatch name(String name) {
  ...
  **/
  ...
  public TimeschedulesCreateOrPatch timezone(TimezoneEnum timezone) {
  ...
  **/
  ...
  public TimeschedulesCreateOrPatch sunday(Map<String, List<Object>> sunday) {
    
    this.sunday = sunday;
    return this;
  }

  public TimeschedulesCreateOrPatch putSundayItem(String key, List<Object> sundayItem) {
    if (this.sunday == null) {
  ...
  **/
  ...
  public TimeschedulesCreateOrPatch monday(Map<String, List<Object>> monday) {
    
    this.monday = monday;
    return this;
  }

  public TimeschedulesCreateOrPatch putMondayItem(String key, List<Object> mondayItem) {
    if (this.monday == null) {
  ...
  **/
  ...
  public TimeschedulesCreateOrPatch tuesday(Map<String, List<Object>> tuesday) {
    
    this.tuesday = tuesday;
    return this;
  }

  public TimeschedulesCreateOrPatch putTuesdayItem(String key, List<Object> tuesdayItem) {
  ...
  **/
  ...
  public TimeschedulesCreateOrPatch wednesday(Map<String, List<Object>> wednesday) {
    
    this.wednesday = wednesday;
    return this;
  }

  public TimeschedulesCreateOrPatch putWednesdayItem(String key, List<Object> wednesdayItem) {
  ...
  **/
  ...
  public TimeschedulesCreateOrPatch thursday(Map<String, List<Object>> thursday) {
    
    this.thursday = thursday;
    return this;
  }

  public TimeschedulesCreateOrPatch putThursdayItem(String key, List<Object> thursdayItem) {
  ...
  **/
  ...
  public TimeschedulesCreateOrPatch friday(Map<String, List<Object>> friday) {
    
    this.friday = friday;
    return this;
  }

  public TimeschedulesCreateOrPatch putFridayItem(String key, List<Object> fridayItem) {
    if (this.friday == null) {
  ...
  **/
  ...
  public TimeschedulesCreateOrPatch saturday(Map<String, List<Object>> saturday) {
    
    this.saturday = saturday;
    return this;
  }

  public TimeschedulesCreateOrPatch putSaturdayItem(String key, List<Object> saturdayItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TimeschedulesCreateOrPatch timeschedulesCreateOrPatch = (TimeschedulesCreateOrPatch) o;
    return Objects.equals(this.name, timeschedulesCreateOrPatch.name) &&
        Objects.equals(this.timezone, timeschedulesCreateOrPatch.timezone) &&
        Objects.equals(this.sunday, timeschedulesCreateOrPatch.sunday) &&
        Objects.equals(this.monday, timeschedulesCreateOrPatch.monday) &&
        Objects.equals(this.tuesday, timeschedulesCreateOrPatch.tuesday) &&
        Objects.equals(this.wednesday, timeschedulesCreateOrPatch.wednesday) &&
        Objects.equals(this.thursday, timeschedulesCreateOrPatch.thursday) &&
        Objects.equals(this.friday, timeschedulesCreateOrPatch.friday) &&
        Objects.equals(this.saturday, timeschedulesCreateOrPatch.saturday);
  }
  ...
  public String toString() {
    ...
    sb.append("class TimeschedulesCreateOrPatch {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to TimeschedulesCreateOrPatch
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TimeschedulesCreateOrPatch.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TimeschedulesCreateOrPatch is not found in the empty JSON string", TimeschedulesCreateOrPatch.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!TimeschedulesCreateOrPatch.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TimeschedulesCreateOrPatch` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TimeschedulesCreateOrPatch.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TimeschedulesCreateOrPatch.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TimeschedulesCreateOrPatch' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TimeschedulesCreateOrPatch> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TimeschedulesCreateOrPatch.class));

       return (TypeAdapter<T>) new TypeAdapter<TimeschedulesCreateOrPatch>() {
           @Override
           public void write(JsonWriter out, TimeschedulesCreateOrPatch value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TimeschedulesCreateOrPatch read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of TimeschedulesCreateOrPatch given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TimeschedulesCreateOrPatch
  * @throws IOException if the JSON string is invalid with respect to TimeschedulesCreateOrPatch
  */
  public static TimeschedulesCreateOrPatch fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TimeschedulesCreateOrPatch.class);
  }

 /**
  * Convert an instance of TimeschedulesCreateOrPatch to an JSON string
  *
  * @return JSON string
  */
